...
## Version
These standards represent version **v-auth-uplift-v2** of the high level standards. See the [versioning section](#versioning) for more information on how versions are managed in the standard.
