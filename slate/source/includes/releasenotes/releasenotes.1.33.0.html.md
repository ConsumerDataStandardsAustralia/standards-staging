...
|Change|Description|Link|
|------|-----------|----|
| Error code metrics | [**Standards Maintenance #655**](https://github.com/ConsumerDataStandardsAustralia/standards-maintenance/issues/655): New version of Get Metrics to explicitly list error codes that Data Holders must report on. | [Get Metrics V6](../../#cdr-admin-api_get-metrics)
