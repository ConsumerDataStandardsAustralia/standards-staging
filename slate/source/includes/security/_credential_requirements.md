...
+ SHALL conduct a risk assessment to determine the authentication level that is appropriate for disclosing consumer data.
```
...
- The algorithm for the creation of the OTP is at the discretion of the data holder but **SHALL** incorporate a level of pseudo-randomness appropriate for the use case. 
