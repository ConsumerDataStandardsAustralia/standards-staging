...
Removed, as they were not referenced:
- [JWA]
- [RFC7521]
- [RFC7523]
...
Updated title and reference for [JWT]:
- [JWT]
+ [JWT] / [RFC8725]

Updated title for [OAUTH2]:
- [OAUTH2]
+ [OAUTH2] / [RFC6749]
...
| <a id="nref-RFC8725"></a><a id="nref-JWT"></a>**[JWT]** / **[RFC8725]** | JSON Web Token (JWT): <https://datatracker.ietf.org/doc/html/rfc8725> | February 2020 |
...
| <a id="nref-OIDD"></a>**[OIDD]** | OpenID Connect Discovery 1.0 incorporating errata set 2: <br><https://openid.net/specs/openid-connect-discovery-1_0.html> | December 2023 |
| <a id="nref-RFC9126"></a><a id="nref-PAR"></a>**[PAR]** / **[RFC9126]** | OAuth 2.0 Pushed Authorization Requests: <https://datatracker.ietf.org/doc/html/rfc9126> | September 2021 |
...
| <a id="nref-RFC9396"></a><a id="nref-RAR"></a>**[RAR]** / **[RFC9396]** | OAuth 2.0 Rich Authorization Requests: <https://datatracker.ietf.org/doc/html/rfc9396> | May 2023 |
| <a id="nref-RFC2119"></a>**[RFC2119]** | Key words for use in RFCs to Indicate Requirement Levels: <https://datatracker.ietf.org/doc/html/rfc2119> | March 1997 |
| <a id="nref-RFC2397"></a>**[RFC2397]** | The "data" URL scheme: <https://datatracker.ietf.org/doc/html/rfc2397> | August 1998 |
| <a id="nref-RFC3339"></a>**[RFC3339]** | Date and Time on the Internet: Timestamps: <https://datatracker.ietf.org/doc/html/rfc3339> | July 2002 |
| <a id="nref-RFC4122"></a>**[RFC4122]** | A Universally Unique IDentifier (UUID) URN Namespace: <https://datatracker.ietf.org/doc/html/rfc4122> | July 2005 |
| <a id="nref-RFC4648"></a>**[RFC4648]** | The Base16, Base32, and Base64 Data Encodings: <https://datatracker.ietf.org/doc/html/rfc4648> | October 2006 |
| <a id="nref-RFC5322"></a>**[RFC5322]** | Internet Message Format: <https://datatracker.ietf.org/doc/html/rfc5322> | October 2008 |
| <a id="nref-RFC6750"></a>**[RFC6750]** | The OAuth 2.0 Authorization Framework: Bearer Token Usage: <https://datatracker.ietf.org/doc/html/rfc6750> | October 2012 |
| <a id="nref-RFC7009"></a>**[RFC7009]** | OAuth 2.0 Token Revocation: <https://datatracker.ietf.org/doc/html/rfc7009> | August 2013 |
...
```diff
Updated links referencing tools.ietf.org, replaced http:// with https://, and updated Informative References detail for: [ACCC], [E.164].  
...
|-----------|-------------|
| <a id="iref-ACCC"></a>**[ACCC]** | The Australian Competition and Consumer Commission is responsible for accrediting data recipients to participate in CDR, building and maintaining the Register of data recipients and data holders, providing support and guidance to participants and promoting compliance with the CDR rules and standards, including taking enforcement action where necessary.<br><https://www.accc.gov.au/by-industry/banking-and-finance/the-consumer-data-right> |
| <a id="iref-ANZSCO"></a>**[ANZSCO]** | ANZSCO - Australian and New Zealand Standard Classification of Occupations: <https://www.abs.gov.au/ANZSCO> |
| <a id="iref-ANZSIC-2006"></a><span style="white-space: nowrap;">**[ANZSIC-2006]**</span> | 1292.0 - Australian and New Zealand Standard Industrial Classification (ANZSIC), 2006 (Revision 2.0): <https://www.abs.gov.au/anzsic> |
| <a id="iref-CDR"></a>**[CDR]** | Consumer Data Right: <https://www.cdr.gov.au> |
| <a id="iref-E-164"></a>**[E.164]** | The international public telecommunication numbering plan: <https://www.itu.int/rec/T-REC-E.164/en> |
...
| <a id="iref-OpenID-Certification"></a><span style="white-space: nowrap;">**[OpenID-Certification]**</span> | The OpenID Foundation enables deployments of OpenID Connect and FAPI to be certified to specific conformance profiles to promote interoperability among implementations.<br><https://openid.net/certification/> |
| <a id="iref-RFC3966"></a>**[RFC3966]** | The tel URI for Telephone Numbers: <https://datatracker.ietf.org/doc/html/rfc3966> |
| <a id="iref-RFC7231"></a>**[RFC7231]** | Hypertext Transfer Protocol (HTTP/1.1): Semantics and Content: <https://datatracker.ietf.org/doc/html/rfc7231> |
