---
title: Get Direct Debits For Account v1
...
# Get Direct Debits For Account Balance V1
This page documents the obsolete version 1 of the Get Direct Debits For Account endpoint.
