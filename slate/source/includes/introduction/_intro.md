...
```diff
Added Dr Scott Farrell as the new Data Standards Chair
```

| Chair | Tenure | Information
| :----- | :------ | :---------- |
| Dr Scott Farrell | December 2025 - present | Dr Scott Farrell serves as the current Data Standards Chair for both the [Consumer Data Right](https://www.cdr.gov.au/about) and [Digital ID](https://www.digitalidsystem.gov.au/how-the-system-works).
| Dr Ian Oppermann | March 2025 - December 2025 | Dr Ian Oppermann served as the Data Standards Chair for both the [Consumer Data Right](https://www.cdr.gov.au/about) and [Digital ID](https://www.digitalidsystem.gov.au/how-the-system-works).
...
## Version
These standards represent version **1.37.0** of the high level standards. See the [versioning section](#versioning) for more information on how versions are managed in the standard.
