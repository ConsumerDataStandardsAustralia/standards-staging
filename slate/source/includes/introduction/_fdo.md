...
|[HTTP Headers](#http-headers) | <ul><li>Data Recipients **SHALL** implement the *x-fapi-end-user-present* header by **May 10th 2027** and **SHALL** continue to send the *x-fapi-customer-ip-address* header until that date.</li><li>Data Recipients **MAY** retire the *x-fapi-auth-date* header immediately.</li><li>Data Holders **SHALL** refer to the *x-fapi-end-user-present* header to determine customer presence for NFR purposes from **May 10th 2027**.</li><li>Data Holders and Data Recipients **SHALL** support *x-cds-authorisation-attempt-id* and *x-cds-authorisation-intent-id* headers as [Correlation Identifiers](#3-2-correlation-identifiers) from **May 10th 2027**.</li></ul> | May 10th 2027 |
